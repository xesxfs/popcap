	...
	export module popcap {
		export module flash {
			export module games {
				export module zuma2 {
					export module logic {
						export class StatsScreen extends egret.HashObject {
							public mTotalScore:flash.TextField;
							public mFruitText:flash.TextField;
							public mGapShotText:flash.TextField;
							public mUpsellButton:egret.SwfButton;
							public mContinueButton:egret.SwfButton;
							public mApp:Zuma2App;
							public mLevel:flash.TextField;
							public mAceTimeText:flash.TextField;
							public mChainText:flash.TextField;
							public mScore:flash.TextField;
							public mFruit:flash.TextField;
							public mCombo:flash.TextField;
							public mBestTimeText:flash.TextField;
							public mPerfectText:flash.TextField;
							public mYourTime:flash.TextField;
							public mSplat:flash.Bitmap;
							public mAceBonusText:flash.TextField;
							public mGapShot:flash.TextField;
							public mTotalScoreText:flash.TextField;
							public mAceTime:flash.TextField;
							public mChain:flash.TextField;
							public mBestTime:flash.TextField;
							public mPerfect:flash.TextField;
							public mAceBonus:flash.TextField;
							public mLevelText:flash.TextField;
							public mComboText:flash.TextField;
							public mScoreText:flash.TextField;
							public mBoard:com.popcap.flash.games.zuma2.widgets.GameBoardWidget;
							public mYourTimeText:flash.TextField;
							public mBackground:flash.Bitmap;

							public constructor(app:Zuma2App,board:com.popcap.flash.games.zuma2.widgets.GameBoardWidget,combo:number,chain:number,gap:number,fruit:number,acetime:number,yourtime:number,acebonus:number,besttime:number,perfect:number,levelpoints:number,totalpoints:number,levelnum:number)
							{
								super();
								combo = flash.checkInt(combo);
								chain = flash.checkInt(chain);
								gap = flash.checkInt(gap);
								fruit = flash.checkInt(fruit);
								acetime = flash.checkInt(acetime);
								yourtime = flash.checkInt(yourtime);
								acebonus = flash.checkInt(acebonus);
								besttime = flash.checkInt(besttime);
								perfect = flash.checkInt(perfect);
								levelpoints = flash.checkInt(levelpoints);
								totalpoints = flash.checkInt(totalpoints);
								levelnum = flash.checkInt(levelnum);
								super();
								this.mApp = app;
								this.mBoard = board;
								...
								var upImage:flash.Bitmap = new flash.Bitmap(this.mApp["imageManager"].getBitmapData(com.popcap.flash.games.zuma2.logic.Zuma2Images.IMAGE_STAT_SCREEN_PLAYAGAIN_BUTTON_UP));
								var downImage:flash.Bitmap = new flash.Bitmap(this.mApp["imageManager"].getBitmapData(com.popcap.flash.games.zuma2.logic.Zuma2Images.IMAGE_STAT_SCREEN_PLAYAGAIN_BUTTON_DOWN));
								var overImage:flash.Bitmap = new flash.Bitmap(this.mApp["imageManager"].getBitmapData(com.popcap.flash.games.zuma2.logic.Zuma2Images.IMAGE_STAT_SCREEN_PLAYAGAIN_BUTTON_OVER));
								var upsellImage:flash.Bitmap = new flash.Bitmap(this.mApp["imageManager"].getBitmapData(com.popcap.flash.games.zuma2.logic.Zuma2Images.IMAGE_STAT_SCREEN_UPSELL_BUTTON_UP));
								this.mContinueButton = new egret.SwfButton(upImage,overImage,downImage,downImage);
								this.mContinueButton.addEventListener(egret.TouchEvent.TOUCH_TAP,flash.bind(this.handlePlayagain,this),null);
								this.mContinueButton.x = 280;
								this.mContinueButton.y = 362;
								this.mUpsellButton = new egret.SwfButton(upsellImage,upsellImage,upsellImage,upsellImage);
								...
								this.mComboText = new flash.TextField();
								...
								this.mComboText.antiAliasType = flash.AntiAliasType.ADVANCED;
								this.mChainText = new flash.TextField();
								...
								this.mGapShotText = new flash.TextField();
								...
								this.mFruitText = new flash.TextField();
								...
								this.mAceTimeText = new flash.TextField();
								...
								this.mYourTimeText = new flash.TextField();
								...
								this.mAceBonusText = new flash.TextField();
								...
								this.mBestTimeText = new flash.TextField();
								...
								this.mTotalScoreText = new flash.TextField();
								...
								aFormat.align = flash.TextFormatAlign.CENTER;
								aFormat.color = 15030548;
								this.mPerfectText = new flash.TextField();
								...
								aFormat.size = 30;
								aFormat.color = 16777215;
								var aShadow:flash.DropShadowFilter = new flash.DropShadowFilter(2,45,1,1,2,2,2,2);
								this.mLevelText = new flash.TextField();
								...
								aFormat.color = 15030548;
								aFormat.size = 24;
								aGlow = new flash.GlowFilter(6305831,1,2,2,10,5);
								this.mScoreText = new flash.TextField();
								...
								aFormat.size = 16;
								aGlow = new flash.GlowFilter(7354630,1,2,2,10,5);
								this.mCombo = new flash.TextField();
								...
								this.mChain = new flash.TextField();
								...
								this.mGapShot = new flash.TextField();
								...
								this.mFruit = new flash.TextField();
								...
								this.mAceTime = new flash.TextField();
								...
								this.mAceBonus = new flash.TextField();
								...
								this.mYourTime = new flash.TextField();
								...
								this.mBestTime = new flash.TextField();
								...
								aFormat.align = flash.TextFormatAlign.CENTER;
								aFormat.size = 18;
								this.mPerfect = new flash.TextField();
								...
								aFormat.align = flash.TextFormatAlign.CENTER;
								aFormat.size = 30;
								this.mLevel = new flash.TextField();
								...
								aFormat.color = 16776960;
								this.mTotalScore = new flash.TextField();
								...
								aFormat.align = flash.TextFormatAlign.CENTER;
								aFormat.size = 24;
								this.mScore = new flash.TextField();
								...
								this.mBackground = new flash.Bitmap(this.mApp["imageManager"].getBitmapData(com.popcap.flash.games.zuma2.logic.Zuma2Images.IMAGE_STAT_SCREEN_BACKGROUND));
								this.mSplat = new flash.Bitmap(this.mApp["imageManager"].getBitmapData(com.popcap.flash.games.zuma2.logic.Zuma2Images.IMAGE_STAT_SCREEN_SPLAT));
								this.mSplat.x = 255;
								this.mSplat.y = 270;
							...
							{
								var url:egret.URLRequest = new egret.URLRequest("http://ad.doubleclick.net/adi/wt.onlinegame.nav/attexit;sz=1x1;ord=0123456789");
								"_blank";
								url;
							}
							...
							public GetTimeText(number:number):string
							{
								number = flash.checkInt(number);
								var minute:string = String(flash.tranint(number / 6000));
								var seconds:string = String(flash.tranint(number % 6000 / 100));
								if(seconds.length == 1)
								{
									seconds = "0" + seconds;
								}
							...
							public GameContinue(e:com.popcap.flash.framework.ads.AdAPIEvent)
							{
								if(this.mApp["mAdAPI"]._isEnabled)
								{
									this.mApp["mAdAPI"].ResumeBroadcast();
								}
								this.mApp["mAdAPI"].removeEventListener(AdAPIEvent.GAME_CONTINUE,flash.bind(this.GameContinue,this));
								this.mApp["soundManager"].playSound(Zuma2Sounds.SOUND_BUTTON_CLICK);
								this.Clear();
								if(this.mApp["mUpsells"])
								{
									if(this.mBoard["mUpsellLevelCount"] >= 3 && <any>!this.mApp["mAdAPI"]._isEnabled || this.mBoard["mLevelNum"] >= 20)
									{
							...
							public handlePlayagain(e:flash.MouseEvent)
							{
								if(this.mApp["mAdAPI"]._isEnabled)
								{
									this.mApp["mAdAPI"].addEventListener(AdAPIEvent.GAME_CONTINUE,flash.bind(this.GameContinue,this));
